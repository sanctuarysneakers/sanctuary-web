    ...
    <div className='newsroom-article'>
      ...
      <div className='newsroom-article-content'>
        ...
        <div className='newsroom-article-text'>
          ...
          <p>
            Colorway displays the price that you will pay for each shoe, before taxes, duties and shipping. Some websites will show you a bid price and
            ...
            may be a lot to get your head around, but that’s why Colorway is here to help!
          </p>
        </div>
        ...
        <div className='newsroom-article-text'>
          ...
          <p>To put it simply, supply and demand. Companies release sneakers in extremely limited quantities, and depending on the model, colorway,
            ...
            instantly, many sellers will resell their pairs at a much higher price, leading to high markups and a need for companies like Colorway
            Sneakers.
          </p>

          <h4>How do I know I’m paying a good price? Hint: Colorway Sneakers</h4>
          <p>Individual reselling websites won’t tell you whether or not you’re looking at the best price available on the internet.
            ...
            at a higher price. Colorway is your shoe-browsing companion. We’ve scraped the web for the best prices available, and we show them to
            you all at once!
          </p>
