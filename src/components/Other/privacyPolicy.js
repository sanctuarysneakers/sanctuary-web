        ...
        <div className='mainCard'>
          <div className='mainCard-content'>
            ...
            <ul>
              <li>
                ...
                <p>For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web
                  page: <a href="https://policies.google.com/privacy" rel="external nofollow noopener noreferrer" target="_blank">policies.google.com/privacy</a></p>
              </li>
            </ul>
            <h2>Advertising</h2>
            ...
            <ul>
              <li>
                ...
                <p>You may opt out of the use of the DoubleClick Cookie for interest-based advertising by visiting the Google
                  Ads Settings web page: <a href="http://www.google.com/ads/preferences/" rel="external nofollow noopener noreferrer" target="_blank">google.com/ads/preferences/</a></p>
              </li>
            </ul>
            ...
            <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the
              Facebook Fan Page <a href="https://www.facebook.com/sanctuarysneakers" rel="external nofollow noopener noreferrer" target="_blank">facebook.com/sanctuarysneakers</a>, the Company and the operator of the social
            ...
            <p>The Company has entered into agreements with Facebook that define the terms for use of the Facebook Fan Page, among
              other things. These terms are mostly based on the Facebook Terms of Service: <a href="https://www.facebook.com/terms.php" rel="external nofollow noopener noreferrer" target="_blank">facebook.com/terms.php</a></p>
            ...
            <ul>
              ...
              <li><p><strong>The right not to be discriminated against.</strong> You have the right not to be discriminated against
                for exercising any of Your Consumer&apos;s rights, including by: <ul> <li>Denying goods or services to You</li> <li>Charging different prices or rates for goods or services, including the use of discounts or other benefits or imposing penalties</li> <li>Providing a different level or quality of goods or services to You</li> <li>Suggesting that You will receive a different price or rate for goods or services or a different level or quality of goods or services.</li></ul>
              </p></li>
            </ul>
