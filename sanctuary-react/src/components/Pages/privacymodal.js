        ...
        <div className="modal-privacy">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Facebook Fan Page</strong> is a public profile named Sanctuary Sneakers specifically created by the
                            Company on the Facebook social network, accessible from <a href="https://www.facebook.com/sanctuarysneakers"
                                rel="external nofollow noopener" target="_blank">https://www.facebook.com/sanctuarysneakers</a></p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Sanctuary, accessible from <a href="https://sanctuarysneakers.com/"
                                rel="external nofollow noopener" target="_blank">https://sanctuarysneakers.com/</a></p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p>You may opt out of the use of the DoubleClick Cookie for interest-based advertising by visiting the Google
                            Ads Settings web page: <a href="http://www.google.com/ads/preferences/" rel="external nofollow noopener"
                                target="_blank">http://www.google.com/ads/preferences/</a></p>
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        ...
                        <p>Their Privacy Policy can be viewed at <a href="https://www.namecheap.com/legal/general/privacy-policy/"
                                ...
                                target="_blank">https://www.namecheap.com/legal/general/privacy-policy/</a></p>
                    </li>
                </ul>
                <h1>GDPR Privacy</h1>
                ...
                <ul>
                    ...
                    <li><strong>Legal obligations:</strong> Processing Personal Data is necessary for compliance with a legal obligation
                        to which the Company is subject.</li>
                    <li><strong>Vital interests:</strong> Processing Personal Data is necessary in order to protect Your vital interests
                        or of another natural person.</li>
                ...
                <ul>
                    <li><strong>Request access to Your Personal Data.</strong> The right to access, update or delete the information We
                        ...
                        assist You. This also enables You to receive a copy of the Personal Data We hold about You.</li>
                    <li><strong>Request correction of the Personal Data that We hold about You.</strong> You have the right to to have
                    ...
                    <li><strong>Object to processing of Your Personal Data.</strong> This right exists where We are relying on a
                        ...
                        the right to object where We are processing Your Personal Data for direct marketing purposes.</li>
                    ...
                    <li><strong>Withdraw Your consent.</strong> You have the right to withdraw Your consent on using your Personal Data.
                ...
                <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the
                    Facebook Fan Page <a href="https://www.facebook.com/sanctuarysneakers" rel="external nofollow noopener"
                        target="_blank">https://www.facebook.com/sanctuarysneakers</a>, the Company and the operator of the social
                ...
                <p>Visit the Facebook Privacy Policy <a href="https://www.facebook.com/policy.php" rel="external nofollow noopener"
                        target="_blank">https://www.facebook.com/policy.php</a> for more information about how Facebook manages Personal
                ...
                <ul>
                    ...
                    <li><strong>The right to access / the right to request.</strong> The CCPA permits You to request and obtain from the
                        ...
                        by the Company or its subsidiaries to a third-party for the third party's direct marketing purposes.</li>
                    <li><strong>The right to say no to the sale of Personal Data.</strong> You also have the right to ask the Company
                    ...
                    <li><strong>The right to know about Your Personal Data.</strong> You have the right to request and obtain from the
                    ...
                    <li><strong>The right to delete Personal Data.</strong> You also have the right to request the deletion of Your
                        Personal Data that have been collected in the past 12 months.</li>
                    <li><strong>The right not to be discriminated against.</strong> You have the right not to be discriminated against
                ...
                <ul>
                    <li>By email: contact@sanctuarysneakers.com</li>
                </ul>
